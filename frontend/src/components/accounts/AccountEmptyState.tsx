  ...
  return (
    <div className="py-16 px-4 text-center max-w-md mx-auto">
      ...
      <h3 className="text-sm font-semibold text-slate-900 mb-1">
        {isFiltered ? "No matching accounts found" : "No accounts registered yet"}
      </h3>
      <p className="text-xs text-slate-500 mb-5 leading-relaxed">
        {isFiltered
          ? "No accounts match your current filter and search query. Try adjusting your search term or resetting the status filter."
          : "Get started by adding your first TikTok account to manage content schedules, analytics, and background worker jobs."}
      </p>
